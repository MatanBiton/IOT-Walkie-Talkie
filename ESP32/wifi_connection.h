...
// Enables/disables infrastructure Wi-Fi at runtime. Disabling station
// connectivity stops connection attempts and disconnects from the AP, but the
// WIFI_STA interface remains active so ESP-NOW P2P continues to operate.
bool isEnabled();
